...
- The first AI-exploration card links to its own detail page and displays the complete long-form image from the legacy `/project-ai-placeholder` page. Keep the optimized local copy under `src/ai-interface-detail/` and preserve its natural tall aspect ratio.
